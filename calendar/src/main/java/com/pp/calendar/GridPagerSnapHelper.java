...
public class GridPagerSnapHelper extends SnapHelper {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        int targetPosition = findTargetPosition(layoutManager, velocityX, velocityY);
        if (-1 != targetPosition) {
//            Log.e("TAG", "targetPosstion: " + targetPosition);
            if (null != onPagerSelectedListener) {
                onPagerSelectedListener.onSelected(targetPosition);
            }
        }
        return targetPosition;
    }

    private int findTargetPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
